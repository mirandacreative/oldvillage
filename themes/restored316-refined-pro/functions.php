...
function refined_footer_creds_text( $creds ) {
    ...
    $creds = '<div class="creds-left">Copyright 2018 Olde Mistick Village</div><div class="creds-right"><div class="mc-logo"><a target="_blank" href="http://www.mirandacreative.com"><img src="http://omv.mirandacreative.com/wp-content/uploads/2018/05/MC.png" /></a></div></div>';
    return $creds;
...
add_action( 'genesis_after_loop', 'about_rent_from_us', 3 );
...
add_action( 'genesis_after_loop', 'contact_info', 4 );
...
if ( is_singular( array( 'businesses', 'deals'))) {
...
function custom_news_loop() {
			  ...
			  <div class="beige-background">
			  	<div class="news-heading">Village News</div>
					  <div class="news-subheading"><h2>Lorem Ipsum Dolor Sit</h2></div>
					...
					<? while ($news->have_posts()) : $news->the_post(); ?>
					  	...
					  	<div class="the-post">
						  	<? $content = get_the_content();
							  	$excerpt = wp_trim_words( $content, 25, NULL);
							?>
					  		<div class="post-image"><? the_post_thumbnail();?></div>
					  		<div class="post-title"><? echo the_title(); ?></div>
					  		<div class="post-excerpt"><? echo $excerpt; ?></div>
					  		<div class="button button-blue"><a target="_blank_" href="<? the_field('article_url');?>">Read More</a></div>
					 	</div>
	...
	//* Create the News Shortcode
add_shortcode('newsloop', 'featured_news');


function custom_news_loop_dine() {
	 $cat = 16;
			$args = array(
			    'post_type'=>'news', 
			    'orderby'=>'desc', 
			  ...
			  ?>
			  <div class="beige-background">
			 		 <div class="news-heading">Dining News</div>
					  <div class="news-subheading"><h2>Lorem Ipsum Dolor Sit</h2></div>
			 	  ?> <div class="featured-news-area">
...
function custom_news_loop_shop() {
	 $cat = 7;
			$args = array(
			    'post_type'=>'news', 
			    'orderby'=>'desc', 
			  ...
			  $news = new WP_Query($args);
			 	  ?> 
				<div class="beige-background">
					<div class="news-heading">Shop News</div>
					  <div class="news-subheading"><h2>Lorem Ipsum Dolor Sit</h2></div>
			 	  <div class="featured-news-area">
...
function custom_news_loop_serv() {
	 $cat = 12;
			$args = array(
			    'post_type'=>'news', 
			    'orderby'=>'desc', 
			  ...
			  $news = new WP_Query($args);
			 	  ?> <div class="featured-news-area">
				  <div class="wrap">
					  <div class="news-heading">Service News</div>
					  <div class="news-subheading"><h2>Lorem Ipsum Dolor Sit</h2></div>
			 <? while ($news->have_posts()) : $news->the_post(); ?>
...
function featured_events () {
	$args = array(
			  ...
			  ?>
					  ...
					  <div class="events-heading"><h3>Featured Events</h3></div>
				 <? while ($events->have_posts()) : $events->the_post(); ?>
				  
					  	<div class="the-post">
						  	<? $content = get_the_content();
							  	$excerpt = wp_trim_words( $content, 20, NULL);
							?>
					  		
					  		<div class="post-image"><? echo the_post_thumbnail(); ?></div>
					  		<div class="post-title"><? echo the_title(); ?></div>
					  		<div class="post-excerpt"><? echo $excerpt; ?></div>
					  		<div class="button button-blue"><a target="_blank_" href="<? the_permalink();?>">View Event</a></div>
					 </div>
...
//* Create the Events Shortcode
add_shortcode( 'events_loop', 'featured_events' );
...
function default_page_template( $template ) {
    ...
    if ( is_singular( 'page' )  ) {
        $default_template = locate_template( array( 'subPage-template.php' ) );
        if ( '' != $default_template ) {
